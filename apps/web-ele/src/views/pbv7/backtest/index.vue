...
const formModel = reactive({
  ...
  long: JSON.stringify(
    {
      close_trailing_grid_ratio: 0.076678,
      close_trailing_qty_pct: 0.10251,
      close_trailing_retracement_pct: 0.032433,
      close_trailing_threshold_pct: 0.088423,
      ema_span_0: 612.26,
      ema_span_1: 358.16,
      enforce_exposure_limit: true,
      entry_grid_double_down_factor: 2.756,
      entry_grid_spacing_pct: 0.093359,
      entry_grid_spacing_weight: 9.2719,
      entry_initial_ema_dist: -0.031437,
      entry_initial_qty_pct: 0.079762,
      entry_trailing_double_down_factor: 1.7243,
      entry_trailing_grid_ratio: 0.39916,
      entry_trailing_retracement_pct: 0.00024503,
      entry_trailing_threshold_pct: 0.028338,
      filter_noisiness_rolling_window: 231.7,
      filter_volume_drop_pct: 0.78651,
      filter_volume_rolling_window: 70.281,
      n_positions: 11,
      total_wallet_exposure_limit: 4.7828,
      unstuck_close_pct: 0.012174,
    },
    null,
    2,
  ),
  short: JSON.stringify(
    {
      ...
      close_trailing_qty_pct: 0.90672,
      close_trailing_retracement_pct: 0.07521,
      close_trailing_threshold_pct: 0.044509,
      ema_span_0: 755.31,
      ema_span_1: 940.08,
      enforce_exposure_limit: true,
      entry_grid_double_down_factor: 0.15216,
      entry_grid_spacing_pct: 0.034679,
      entry_grid_spacing_weight: 7.7826,
      entry_initial_ema_dist: -0.074536,
      entry_initial_qty_pct: 0.010273,
      entry_trailing_double_down_factor: 1.4518,
      entry_trailing_grid_ratio: 0.38384,
      entry_trailing_retracement_pct: 0.086548,
      entry_trailing_threshold_pct: 0.052839,
      filter_noisiness_rolling_window: 251.42,
      filter_volume_drop_pct: 0.78176,
      filter_volume_rolling_window: 17.988,
      n_positions: 1,
      total_wallet_exposure_limit: 2.9599,
      unstuck_close_pct: 0.059267,
    },
    null,
    2,
  ),
...
function handleSubmit() {
  console.log('Form Submitted:', formModel);
}
</script>
...
<template>
  ...
  >
    <template #extra>
      <ElButton class="mb-2" type="primary" @click="handleSubmit"
        >运行回测</ElButton
      >
    </template>
    <ElCard>
              ...
              <ElRow :gutter="20">
                ...
                <ElCol :span="6">
                  <ElFormItem label="long positions">
                    <ElInputNumber
                      v-model="override.long_positions"
                      class="w-full"
                    />
                  </ElFormItem>
                </ElCol>
                ...
                <ElCol :span="6">
                  <ElFormItem label="short positions">
                    <ElInputNumber
                      v-model="override.short_positions"
                      class="w-full"
                    />
                  </ElFormItem>
                </ElCol>
